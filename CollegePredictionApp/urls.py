...
urlpatterns = [
    ...
    path("UserLoginAction.html", views.UserLoginAction,
         name="UserLoginAction"),
    path("Signup.html", views.Signup, name="Signup"),
    path("SignupAction", views.SignupAction, name="SignupAction"),
    path("PredictCollege.html", views.PredictCollege,
         name="PredictCollege"),
    path("PredictCollegeAction", views.PredictCollegeAction,
         name="PredictCollegeAction"),
]
